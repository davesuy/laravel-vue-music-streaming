...
<template>
    <div
        id="TopNav"
        class="fixed bg-[#191922] right-0 flex items-center justify-between w-[calc(100%-240px)] h-[56px] border-b border-b-[#32323D]"
    >
    ...
    <div class="fixed w-[calc(100%-240px)] h-[calc(100%-56px)] ml-[240px] mt-[56px] overflow-x-auto bg-[#191922]">
        <RouterView />
    </div>
